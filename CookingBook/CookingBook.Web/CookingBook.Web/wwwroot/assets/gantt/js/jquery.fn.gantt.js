    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            init: function (element) {
                ...
                // fill available right panel width mnm
            ...
            createProgressBar: function (label, desc, classNames, dataObj) {                
                label = label || "";
                //mnm you changed this
                var bar = $('<div class="bar" style="background-color: ' + classNames + '"><div class="fn-label">' + label + '</div></div>')
            ...
            // **Fill the Chart mnm you added this**
